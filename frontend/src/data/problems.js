...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  "set-matrix-zeroes": {
    ...
    description: {
      text: "You are given a 2D matrix of integers. If any cell contains the value 0, update the matrix so that the entire row and column of that cell are set to 0. The modification must be done directly on the input matrix.",
      notes: [
        "You must modify the matrix in-place.",
        "Try to optimize for space usage.",
      ],
    },
    examples: [
      {
